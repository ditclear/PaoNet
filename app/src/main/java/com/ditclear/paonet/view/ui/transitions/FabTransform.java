...
package com.ditclear.paonet.view.ui.transitions;
...
import com.ditclear.paonet.view.helper.AnimUtils;
...
public class FabTransform extends Transition {
    ...
    private static final String PROP_BOUNDS = "paonet:fabTransform:bounds";
