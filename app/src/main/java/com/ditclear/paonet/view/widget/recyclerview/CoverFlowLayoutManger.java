package com.ditclear.paonet.view.widget.recyclerview;
...
public class CoverFlowLayoutManger extends LinearLayoutManager{
    ...
    public CoverFlowLayoutManger(Context context,boolean isFlat, boolean isGreyItem,
...
//            cm.setSaturation(0.9f);
    ...
    public static class Builder {
        ...
        public CoverFlowLayoutManger build() {
            return new CoverFlowLayoutManger(mContext,isFlat, isGreyItem,
