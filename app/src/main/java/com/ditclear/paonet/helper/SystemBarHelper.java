...
public class SystemBarHelper {
    ...
    /**
     * Android4.4以上的状态栏着色(针对于DrawerLayout) 注: 1.如果出现界面展示不正确,删除布局中所有fitsSystemWindows属性,尤其是DrawerLayout的fitsSystemWindows属性
    ...
    /**
     * Android4.4以上的沉浸式全屏模式 注: 1.删除fitsSystemWindows属性:Android5.0以上使用该方法如果出现界面展示不正确,删除布局中所有fitsSystemWindows属性
     * 或者调用forceFitsSystemWindows方法 2.不删除fitsSystemWindows属性:也可以区别处理,Android5.0以上使用自己的方式实现,不调用该方法
     *
     * @param activity Activity对象
     */
    ...
    public static boolean isFlyme4Later() {
        return Build.FINGERPRINT.contains("Flyme_OS_4")
                ...
                || Pattern.compile("Flyme [4|5|6]", Pattern.CASE_INSENSITIVE).matcher(Build.DISPLAY).find();
    }
